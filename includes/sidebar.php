 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>PC Point</h1></span> 
...
{               ?>
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-info" aria-hidden="true"></i> <span> Clients</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-file"></i> <span> Files</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="invoices.php">File Lists</a></li>
                    <li id="menu-academico-boletim" ><a href="#">Add New Files</a></li>
