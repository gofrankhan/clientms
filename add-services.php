...
$sql="insert into tblservices(ServiceCategory,ServiceName,ServicePrice)values(:scategory,:sname,:price)";
...
<form method="post"> 
	...
	<div class="form-group"> <label for="exampleInputEmail1">Service Category</label> <input type="text" name="scategory" placeholder="Service Category" value="" class="form-control" required='true'> </div>
